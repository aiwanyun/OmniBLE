...
struct PairPodView: View {
    ...
    var body: some View {
            ...
            VStack {
                ...
                HStack {
                    InstructionList(instructions: [
                        LocalizedString("用U-100胰岛素填充新的豆荚（留下蓝色豆荚针盖）。", comment: "Label text for step 1 of pair pod instructions"),
                        LocalizedString("听2个哔哔声。", comment: "Label text for step 2 of pair pod instructions")
                    ])
        ...
        .navigationBarTitle(LocalizedString("配对豆荚", comment: "Pair Pod navigationBarTitle"), displayMode: .automatic)
