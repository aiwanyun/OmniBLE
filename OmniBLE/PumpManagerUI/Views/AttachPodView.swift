...
struct AttachPodView: View {
    ...
    var body: some View {
            ...
            VStack {
                ...
                HStack {
                    InstructionList(instructions: [
                        ...
                        LocalizedString("卸下蓝色吊舱针帽并检查套管。然后取下纸张衬里。", comment: "Label text for step two of attach pod instructions"),
        ...
        .navigationBarTitle(LocalizedString("附加吊舱", comment: "navigation bar title attach pod"), displayMode: .automatic)
