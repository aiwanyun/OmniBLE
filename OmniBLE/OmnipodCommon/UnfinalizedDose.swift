...
public struct UnfinalizedDose: RawRepresentable, Equatable, CustomStringConvertible {
    ...
    public var description: String {
        ...
        case .tempBasal:
            ...
            return String(format: LocalizedString("临时基础: %1$@ U/小时 %2$@ %3$@ %4$@ U %5$@", comment: "The format string describing a temp basal. (1: The rate)(2: Start time)(3: duration)(4: volume)(5: scheduled certainty"), rateStr, startTimeStr, durationStr, volumeStr, scheduledCertainty.localizedDescription)
        case .suspend:
    ...
    public var eventTitle: String {
        ...
        case .suspend:
            return NSLocalizedString("暂停", comment: "Pump Event title for UnfinalizedDose with doseType of .suspend")
        case .tempBasal:
            return NSLocalizedString("温度基", comment: "Pump Event title for UnfinalizedDose with doseType of .tempBasal")
        }
    }
