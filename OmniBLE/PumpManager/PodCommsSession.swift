...
//    }
    ...
    public var recoverySuggestion: String? {
        ...
        case .podNotConnected:
            return LocalizedString("确保您的豆荚在附近，然后重试。", comment: "Recovery suggestion when no pod is available")
        case .unfinalizedBolus:
        ...
        case .activationTimeExceeded:
            return nil
        case .rssiTooLow:
            return LocalizedString("请重新定位iPhone相对于豆荚", comment: "Recovery suggestion when pairing signal strength is too low")
        case .rssiTooHigh:
            return LocalizedString("请从豆荚进一步重新定位iPhone", comment: "Recovery suggestion when pairing signal strength is too high")
